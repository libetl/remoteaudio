...
public class DHGexParameters {
    ...
    public DHGexParameters (int pref_group_len) {
        if (pref_group_len < DHGexParameters.MIN_ALLOWED
                || pref_group_len > DHGexParameters.MAX_ALLOWED) {
    ...
    public DHGexParameters (int min_group_len, int pref_group_len,
            int max_group_len) {
        if (min_group_len < DHGexParameters.MIN_ALLOWED
                || min_group_len > DHGexParameters.MAX_ALLOWED) {
        ...
        if (max_group_len < DHGexParameters.MIN_ALLOWED
                || max_group_len > DHGexParameters.MAX_ALLOWED) {
