 ...
 * @version $Id: SFTPv3FileAttributes.java,v 1.3 2006/09/04 07:41:46 cplattne
 *          Exp $
 */
...
public class SFTPv3FileAttributes {
    ...
    public String getOctalPermissions () {
        ...
        String res = Integer.toString (this.permissions.intValue () & 0177777,
                8);
    ...
    public boolean isDirectory () {
        ...
        return (this.permissions.intValue () & 0040000) != 0;
    }
    ...
    public boolean isRegularFile () {
        ...
        return (this.permissions.intValue () & 0100000) != 0;
    }
    ...
    public boolean isSymlink () {
        ...
        return (this.permissions.intValue () & 0120000) != 0;
    }
}
