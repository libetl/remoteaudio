...
public class Session {
    ...
    public void requestPTY (String term, int term_width_characters,
        ...
        this.cm.requestPTY (this.cn, term, term_width_characters,
     ...
     * @throws IOException
     */
    public void requestX11Forwarding (String hostname, int port,
            byte [] cookie, boolean singleConnection) throws IOException {
        if (hostname == null) {
        ...
        while (true) {
            ...
            if (this.cm.checkX11Cookie (hexEncodedFakeCookie) == null) {
                break;
            }
        }
        ...
        this.cm.requestX11 (this.cn, singleConnection, "MIT-MAGIC-COOKIE-1",
    ...
    public int waitUntilDataAvailable (long timeout) throws IOException {
        ...
        int conditions = this.cm.waitForCondition (this.cn, timeout,
