...
public class Channel {
    ...
    static final int          CHANNEL_BUFFER_SIZE = 65536;
    ...
    int                       state               = Channel.STATE_OPENING;
    ...
    final byte []             stdoutBuffer        = new byte [Channel.CHANNEL_BUFFER_SIZE];
    final byte []             stderrBuffer        = new byte [Channel.CHANNEL_BUFFER_SIZE];
    ...
    public Channel (ChannelManager cm) {
        ...
        this.localWindow = Channel.CHANNEL_BUFFER_SIZE;
        this.localMaxPacketSize = Channel.CHANNEL_BUFFER_SIZE - 1024; // leave enough slack
