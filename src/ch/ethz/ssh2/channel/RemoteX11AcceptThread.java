 ...
 * @version $Id: RemoteX11AcceptThread.java,v 1.5 2006/02/14 15:17:37 cplattne
 *          Exp $
 */
public class RemoteX11AcceptThread extends Thread {
    ...
    public void run () {
        try {
             ...
             * X Version 11, Releases 6 and 6.1 ISBN 1-55558-148-X (from the ETH
             * library - after being here for almost ten years one of the few
             * books I borrowed... sad but true =)
             */
            ...
            for (byte element : authProtocolData) {
                String digit2 = Integer.toHexString (element & 0xff);
            ...
            StreamForwarder r2l = new StreamForwarder (this.c, null, null,
                    remote_is, x11_os, "RemoteToX11");
            StreamForwarder l2r = new StreamForwarder (this.c, null, null,
                    x11_is, remote_os, "X11ToRemote");
            ...
            RemoteX11AcceptThread.log.log (50,
