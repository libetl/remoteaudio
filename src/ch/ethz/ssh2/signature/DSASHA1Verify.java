...
public class DSASHA1Verify {
    ...
    public static DSASignature decodeSSHDSASignature (byte [] sig)
        ...
        if (DSASHA1Verify.log.isEnabled ()) {
            DSASHA1Verify.log.log (30,
                    "decoded ssh-dss signature: first bytes r("
                            + (rsArray [0] & 0xff) + "), s("
                            + (rsArray [20] & 0xff) + ")");
        }
    ...
    public static DSASignature generateSignature (byte [] message,
        ...
        k = k.modInverse (pk.getQ ())
                .multiply (m.add (pk.getX ().multiply (r)));
    ...
    public static boolean verifySignature (byte [] message, DSASignature ds,
        ...
        if (DSASHA1Verify.log.isEnabled ()) {
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: m: " + m.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: r: " + r.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: s: " + s.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: g: " + g.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: p: " + p.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: q: " + q.toString (16));
            DSASHA1Verify.log.log (60,
                    "ssh-dss signature: y: " + y.toString (16));
        }
